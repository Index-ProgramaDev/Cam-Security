...
class EventLogger:
    ...
    def log_event(self, event_type: str, track_id: int, risk_score: int,
                  description: str = "", evidence_path: str = ""):
        entry = {
        ...
        try:
            ...
            sys_logger.info(
                f"[AUDITORIA] Evento '{event_type}' registrado para Track #{track_id} (Risco: {risk_score})"
            )
